# Scenario: S: cross-group with index
...
|-----|-----------|------|----------|---------|--------|--------|---------|
| 0 | 2026-04-12T15:20:22.799Z | TAB | 0 | 1 | [{"tabRefId":"tab-5","label":"package.json","kind":"text","viewColumn":2,"index":3,"isActive":false,"isDirty":false,"isPinned":false,"isPreview":false,"uri":"file:///workspace/package.json"}] |  |  |
| 1 | 2026-04-12T15:20:22.800Z | TAB | 1 | 2 |  |  | [{"tabRefId":"tab-5","label":"package.json","kind":"text","viewColumn":2,"index":3,"isActive":true,"isDirty":false,"isPinned":false,"isPreview":false,"uri":"file:///workspace/package.json"}] |
| 2 | 2026-04-12T15:20:22.800Z | GROUP | 2 | 3 |  |  | [{"groupRefId":"group-3","viewColumn":1,"isActive":true,"activeTabRefId":"tab-6","tabCount":1,"tabLabels":["package.json"],"tabRefIds":["tab-6"]},{"groupRefId":"group-4","viewColumn":2,"isActive":false,"activeTabRefId":"tab-7","tabCount":4,"tabLabels":["README.md","tsconfig.json","vitest.config.ts","package.json"],"tabRefIds":["tab-8","tab-9","tab-10","tab-7"]}] |
| 3 | 2026-04-12T15:20:22.803Z | GROUP | 3 | 4 |  |  | [{"groupRefId":"group-4","viewColumn":2,"isActive":true,"activeTabRefId":"tab-7","tabCount":4,"tabLabels":["README.md","tsconfig.json","vitest.config.ts","package.json"],"tabRefIds":["tab-8","tab-9","tab-10","tab-7"]}] |
| 4 | 2026-04-12T15:20:22.804Z | GROUP | 4 | 5 |  |  | [{"groupRefId":"group-5","viewColumn":1,"isActive":false,"activeTabRefId":null,"tabCount":1,"tabLabels":["package.json"],"tabRefIds":["tab-11"]},{"groupRefId":"group-6","viewColumn":2,"isActive":true,"activeTabRefId":"tab-12","tabCount":4,"tabLabels":["README.md","tsconfig.json","vitest.config.ts","package.json"],"tabRefIds":["tab-13","tab-14","tab-15","tab-12"]}] |
| 5 | 2026-04-12T15:20:22.804Z | TAB | 5 | 6 |  | [{"tabRefId":"tab-11","label":"package.json","kind":"text","viewColumn":1,"index":-1,"isActive":false,"isDirty":false,"isPinned":false,"isPreview":false,"uri":"file:///workspace/package.json"}] |  |
| 6 | 2026-04-12T15:20:22.808Z | GROUP | 6 | 7 |  | [{"groupRefId":"group-5","viewColumn":1,"isActive":false,"activeTabRefId":null,"tabCount":0,"tabLabels":[],"tabRefIds":[]}] | [{"groupRefId":"group-7","viewColumn":1,"isActive":true,"activeTabRefId":"tab-16","tabCount":4,"tabLabels":["README.md","tsconfig.json","vitest.config.ts","package.json"],"tabRefIds":["tab-17","tab-18","tab-19","tab-16"]}] |
| 7 | 2026-04-12T15:20:22.809Z | GROUP | 7 | 8 |  |  | [{"groupRefId":"group-8","viewColumn":1,"isActive":true,"activeTabRefId":"tab-20","tabCount":4,"tabLabels":["README.md","tsconfig.json","vitest.config.ts","package.json"],"tabRefIds":["tab-21","tab-22","tab-23","tab-20"]}] |

### Snapshot Diffs

**[seq=0, time=2026-04-12T15:20:22.799Z] TAB v0 -> v1** — 4 change(s)
...
**[seq=1, time=2026-04-12T15:20:22.800Z] TAB v1 -> v2** — 3 change(s)
...
**[seq=2, time=2026-04-12T15:20:22.800Z] GROUP v2 -> v3** — 14 change(s)
...
**[seq=3, time=2026-04-12T15:20:22.803Z] GROUP v3 -> v4** — 2 change(s)
...
**[seq=4, time=2026-04-12T15:20:22.804Z] GROUP v4 -> v5** — 15 change(s)
...
**[seq=5, time=2026-04-12T15:20:22.804Z] TAB v5 -> v6** — 4 change(s)
...
**[seq=6, time=2026-04-12T15:20:22.808Z] GROUP v6 -> v7** — 17 change(s)
...
**[seq=7, time=2026-04-12T15:20:22.809Z] GROUP v7 -> v8** — 10 change(s)
