...
const ICON_BY_KIND: Partial<
  Record<TabKind, { icon: string; className: string }>
> = {
  [TabKind.TabInputTerminal]: {
    icon: 'codicon-terminal',
    className: 'kind-icon-terminal'
  },
  [TabKind.TabInputWebview]: {
    icon: 'codicon-browser',
    className: 'kind-icon-webview'
  },
  [TabKind.TabInputCustom]: {
    icon: 'codicon-extensions',
    className: 'kind-icon-custom'
  },
  [TabKind.Unknown]: {
    icon: 'codicon-question',
    className: 'kind-icon-unknown'
  }
};
...
export const TabKindIcon: React.FC<TabKindIconProps> = React.memo(
  ({ kind, fileName, color }) => {
