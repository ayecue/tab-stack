...
VS Code already remembers a bit of your layout, but it isn’t built for:
...
That’s it — from here you can start building up groups, snapshots, and add‑ons as your workflow evolves.
